...
{
       0,   205,   205,   206,   215,   216,   217,   211,   222,   223,
     225,   228,   230,   235,   237,   239,   242,   244,   246,   248,
     250,   252,   254,   256,   258,   262,   266,   268,   272,   276,
     281,   282,   286,   290,   294,   297,   301,   305,   307,   310,
     313,   315,   317,   319,   321,   323,   327,   328,   329,   332,
     334,   336,   338,   342,   344,   346,   348,   350,   354,   356,
     360,   362,   366,   370
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ENDLOOP", "CONTINUE", "BREAK", "READ", "WRITE", "TRUE", "FALSE",
  "RETURN", "MOD", "EQ", "NEQ", "LT", "GT", "LTE", "GTE", "ADD", "SUB",
  "MULT", "DIV", "L_SQUARE_BRACKET", "R_SQUARE_BRACKET", "L_PAREN",
  "R_PAREN", "ASSIGN", "NOT", "NUM", "IDENT", "SEMICOLON", "COLON",
  "COMMA", "$accept", "start", "function", "$@1", "$@2", "$@3",
  "declarations", "declaration", "statements", "statement", "vars", "ifs",
  "whiles", "dos", "varLoop", "reads", "writes", "continues", "breaks",
  "returns", "bool_exp", "comp", "expression", "mul_exp", "term",
  "expression_list", "var", "numbers", "identifiers", YY_NULLPTR
};
#endif
...
{
     -52,    62,   -52,   -30,   -52,   -52,   -37,    29,   -30,    46,
       2,   -11,    66,   -52,   -30,    13,   -30,   -52,   -52,    72,
     105,    69,   107,    73,    56,   104,    75,    75,    98,   -52,
     -52,   -30,   -30,    40,   109,     3,   -52,   -52,   -52,   -52,
     -52,   -52,   -52,   -52,   -52,    77,    82,   112,    75,    -5,
      12,    56,    78,    78,    40,   -52,    70,   -20,   -52,   -52,
     -52,    43,   -52,   -52,    56,    40,    40,   -52,    30,    56,
      65,    56,   103,   -30,   -52,   -52,   -16,    40,    40,    40,
      40,    40,    18,   -52,   -52,    70,    68,    76,   -52,   -52,
     -52,   -52,   -52,   -52,    40,   106,   108,    78,   -52,   -20,
     -20,   -52,   -52,   -52,   -52,    70,    -7,   -52,   -52,   -52,
      56,    70,   -52,    75,   -52,   -52,    40,   -52,   113,    40,
      70,   -52
};
...
{
       2,     0,     1,     0,     3,    63,     0,     0,     8,     0,
       0,     0,     0,    10,     8,     0,     8,     9,    11,     0,
       0,     0,     0,     0,     0,     0,    39,    39,     0,    34,
      35,     0,     0,     0,     0,     0,    16,    17,    18,    19,
      20,    21,    22,    23,    24,     0,    60,     0,    39,     0,
       0,     0,    30,    30,     0,    62,    36,    46,    49,    53,
      54,    60,     4,    15,    14,     0,     0,    12,    38,     0,
       0,     0,     0,     0,    32,    33,     0,     0,     0,     0,
       0,     0,     0,     5,    13,    25,     0,     0,    40,    41,
      42,    43,    44,    45,     0,     0,     0,    30,    55,    47,
      48,    52,    50,    51,    56,    59,     0,     6,    61,    26,
       0,    37,    28,    39,    31,    57,     0,     7,     0,    29,
      58,    27
};
...
{
     -52,   -52,   -52,   -52,   -52,   -52,    74,   -52,   -39,   -52,
     -52,   -52,   -52,   -52,   -51,   -52,   -52,   -52,   -52,   -52,
     -26,   -52,   -27,    32,   -36,   -52,   -17,   -52,    -3
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     4,    83,   107,   117,     9,    10,    34,    35,
      36,    37,    38,    39,    74,    40,    41,    42,    43,    44,
      49,    94,    70,    57,    58,   106,    59,    60,    61
};
...
{
       6,    50,    75,    13,    63,    11,    56,    45,    79,    69,
       7,    11,    72,    11,    52,    53,     5,    80,    81,    77,
      78,    46,    68,    18,    19,    84,    98,    76,    46,    46,
      87,    71,    95,     8,    45,   115,    54,    15,    85,    86,
      55,     5,   116,   101,   102,   103,   114,    45,    46,    14,
      64,    12,    45,    54,    45,   105,    97,    55,     5,    54,
     104,    46,     2,    55,     5,     3,    46,   111,    46,    26,
      46,   118,    16,    27,    28,    55,     5,    29,    30,    31,
      32,    54,    66,    33,    82,    55,     5,   119,    17,   120,
      20,   109,   110,    45,    88,    89,    90,    91,    92,    93,
      77,    78,     5,    77,    78,    77,    78,    46,   108,    99,
     100,    21,    22,    25,    23,    24,    47,    51,    62,    48,
      65,    66,    67,    96,     0,   113,   112,    73,   121
};

static const yytype_int8 yycheck[] =
{
       3,    27,    53,     1,     1,     8,    33,    24,    28,    14,
      47,    14,    51,    16,    31,    32,    46,    37,    38,    35,
      36,    24,    48,    10,    11,    64,    42,    54,    31,    32,
      69,    19,    71,     4,    51,    42,    41,    48,    65,    66,
      45,    46,    49,    79,    80,    81,    97,    64,    51,    47,
      47,     5,    69,    41,    71,    82,    73,    45,    46,    41,
      42,    64,     0,    45,    46,     3,    69,    94,    71,    13,
      73,   110,     6,    17,    18,    45,    46,    21,    22,    23,
      24,    41,    39,    27,    41,    45,    46,   113,    14,   116,
      16,    15,    16,   110,    29,    30,    31,    32,    33,    34,
      35,    36,    46,    35,    36,    35,    36,   110,    40,    77,
      78,    39,     7,    40,    45,     8,    12,    19,     9,    44,
      43,    39,    10,    20,    -1,    17,    20,    49,    15
};
...
{
       0,    51,     0,     3,    52,    46,    78,    47,     4,    56,
      57,    78,     5,     1,    47,    48,     6,    56,    10,    11,
      56,    39,     7,    45,     8,    40,    13,    17,    18,    21,
      22,    23,    24,    27,    58,    59,    60,    61,    62,    63,
      65,    66,    67,    68,    69,    76,    78,    12,    44,    70,
      70,    19,    76,    76,    41,    45,    72,    73,    74,    76,
      77,    78,     9,     1,    47,    43,    39,    10,    70,    14,
      72,    19,    58,    49,    64,    64,    72,    35,    36,    28,
      37,    38,    41,    53,    58,    72,    72,    58,    29,    30,
      31,    32,    33,    34,    71,    58,    20,    76,    42,    73,
      73,    74,    74,    74,    42,    72,    75,    54,    40,    15,
      16,    72,    20,    17,    64,    42,    49,    55,    58,    70,
      72,    15
};
